...
<div class="topnav">
<img  class="headerlogo" src="/images/logo.png" width="220px" height="170px" style="margin-top: 10px; margin-left:30px;">
...
<div class="centered">
  <b><h4 class="text textbox">Do Something Today That Your </br>Future Self Will Thank</br>You For
</h1></b></div>
<div class="container">
...
<div class="row">
    ...
    <div class="menu size" style="margin-bottom: 100px; margin-top:40px; margin-left:170px;">
            ...
            <b><a href="/staffHome">Staff </br> Management</a></b></h4>
...
<div class="menu size" style="margin-bottom: 100px; margin-top:40px; margin-left:170px;">
            ...
            <h4
            style="margin-top:20px;">
            <b><a href="/studentHome">Student</br> Management</a></b></h4>
...
<div class="menu size" style="margin-bottom: 100px; margin-top:40px; margin-left:170px;">
            ...
            <h4
            style="margin-top:20px;">
            <b><a href="eventHome">Events</br> Management</a></b></h4>
...
<div class="menu size" style="margin-bottom: 100px; margin-top:40px; margin-left:170px; ">
            ...
            <h4
            style="margin-top:20px;">
            <b><a href="/payrollHome">Payroll </br>Management</a></b></h4>
...
<table style="width: 80%;" align="center">
    <tr>
        <td>
            <p><b>Services</b><br> Student Management <br> Staff Management<br>Events Management<br>Payroll Management<br></p>
        </td>
        <td>
        <p><b>Contact Us</b><br>HotLine: +9411 2729568<br>Phone: +9411 2123789<br>E-mail: ellucian.info@yahoo.com <br>
        </td>
        <td>
            <p>Follow Us On,</p>
            <div>
